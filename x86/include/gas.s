...
.equ SYS_UTIMENSAT, 320
.equ SYS_SIGNALFD, 321
.equ SYS_TIMERFD_CREATE, 322
.equ SYS_EVENTFD, 323
.equ SYS_FALLOCATE, 324
.equ SYS_TIMERFD_SETTIME, 325
.equ SYS_TIMERFD_GETTIME, 326
.equ SYS_SIGNALFD4, 327
.equ SYS_EVENTFD2, 328
.equ SYS_EPOLL_CREATE1, 329
.equ SYS_DUP3, 330
.equ SYS_PIPE2, 331
.equ SYS_INOTIFY_INIT1, 332
.equ SYS_PREADV, 333
.equ SYS_PWRITEV, 334
.equ SYS_RT_TGSIGQUEUEINFO, 335
.equ SYS_PERF_EVENT_OPEN, 336
.equ SYS_RECVMMSG, 337
.equ SYS_FANOTIFY_INIT, 338
.equ SYS_FANOTIFY_MARK, 339
.equ SYS_PRLIMIT64, 340
.equ SYS_NAME_TO_HANDLE_AT, 341
.equ SYS_OPEN_BY_HANDLE_AT, 342
.equ SYS_CLOCK_ADJTIME, 343
.equ SYS_SYNCFS, 344
.equ SYS_SENDMMSG, 345
.equ SYS_SETNS, 346
.equ SYS_PROCESS_VM_READV, 347
.equ SYS_PROCESS_VM_WRITEV, 348
.equ SYS_KCMP, 349
.equ SYS_FINIT_MODULE, 350
.equ SYS_SCHED_SETATTR, 351
.equ SYS_SCHED_GETATTR, 352
.equ SYS_RENAMEAT2, 353
.equ SYS_SECCOMP, 354
.equ SYS_GETRANDOM, 355
.equ SYS_MEMFD_CREATE, 356
.equ SYS_BPF, 357
.equ SYS_EXECVEAT, 358
.equ SYS_SOCKET, 359
...
.equ SYS_LISTEN, 363
.equ SYS_ACCEPT4, 364
.equ SYS_GETSOCKOPT, 365
.equ SYS_SETSOCKOPT, 366
.equ SYS_GETSOCKNAME, 367
.equ SYS_GETPEERNAME, 368
.equ SYS_SENDTO, 369
.equ SYS_SENDMSG, 370
.equ SYS_RECVFROM, 371
.equ SYS_RECVMSG, 372
.equ SYS_SHUTDOWN, 373
.equ SYS_USERFAULTFD, 374
.equ SYS_MEMBARRIER, 375
.equ SYS_MLOCK2, 376
.equ SYS_COPY_FILE_RANGE, 377
.equ SYS_PREADV2, 378
.equ SYS_PWRITEV2, 379
.equ SYS_PKEY_MPROTECT, 380
.equ SYS_PKEY_ALLOC, 381
.equ SYS_PKEY_FREE, 382
.equ SYS_STATX, 383
.equ SYS_ARCH_PRCTL, 384
